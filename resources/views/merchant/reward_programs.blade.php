...
<div class="p-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold">Reward Programs</h1>
        <div class="flex gap-3">
            <a href="{{ route('merchant.listing-fees') }}" class="bg-indigo-600 text-white px-4 py-2 rounded hover:bg-indigo-700">Listing Fees</a>
